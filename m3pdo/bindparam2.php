...
$query = $pdo->prepare(
    'INSERT INTO `colors` (`name`) VALUES (:newColor);'
);
$userInput = 'Green';   //simulate input from user

//$query->bindParam(':newColor', $userInput);

// 3. Execute query

$query->execute(['newColor'=> $userInput]); //an alternative to bindParam

echo 'Done - bindparam2.php';